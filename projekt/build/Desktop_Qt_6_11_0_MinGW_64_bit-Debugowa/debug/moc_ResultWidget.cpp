...
template <> constexpr inline auto ResultWidget::qt_create_metaobjectdata<qt_meta_tag_ZN12ResultWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "ResultWidget",
        "executeCodeRequested",
        "",
        "code"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'executeCodeRequested'
...
void ResultWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->executeCodeRequested((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ResultWidget::*)(const QString & )>(_a, &ResultWidget::executeCodeRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void ResultWidget::executeCodeRequested(const QString & _t1)
{
